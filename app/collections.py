...
data_collection = [
    ...
    DataItem("img/Code.png", "Задача Tinkoff Start", Path(data_path, "Tinkoff_task.txt"), True, False, True),
    DataItem("img/Master.jpg", "Булгаков М. А. Мастер и Маргарита", Path(data_path, "Master.txt"), True, False)
]
